...
module App =   
    ...
    let view (m : AdaptiveModel) =
        ...
        let cameraFootprints =
            SourceLinkingApp.view m.sourceLinking 
            |> Sg.map SourceLinkingAction
    ...
    let app dir axisFile (qposFolder : option<string>) (rotate : bool) =
        ...
        let camState = 
            camState |> ffConfig ^= CameraControllerState.freeFlyConfig_
    
        //dockconfig ViewerMain
        ...
        let initialModel = { initialModel with sourceLinking = sourceLinking }
